          ...
          <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div className="relative w-full">
                      ...
                      <input className="block p-3 pl-10 w-full text-sm rounded-l-lg  bordersm:rounded-none sm:rounded-l-lg bg-gray-200 border-gray-600 placeholder-gray-400 text-white focus:ring-orange-400 focus:border-orange-400" placeholder="Enter your email" type="email" id="email" required />
                  </div>
                  <div>
