...
const Settings = ({ user, listings }: any) => {
  ...
  // social modal
  const [instagram, setInstagram] = useState(user?.profile?.social?.instagram || '');
  const [facebook, setFacebook] = useState(user?.profile?.social?.facebook || '');
  ...
  const [linkedin, setLinkedin] = useState(user?.profile?.social?.linkedin || '');
      ...
      <div className="container px-4 mx-auto">
        <div className="lg:flex lg:flex-wrap mt-10 gap-6">
            <div className="lg:w-1/4 flex lg:block mb-4">
                <div className="border border-gray-200 p-4 bg-white flex gap-2 items-center">
                    <BiUser />
                    <span>
                       Profile 
                    </span>
          ...
          <form action="">
            ...
            <div className="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
              <div className="w-full sm:w-1/3 px-4 mb-5 sm:mb-0">
                ...
                <span className="text-xs ">Write a short bio on yourself</span>
              </div>
              <div className="w-full sm:w-2/3 px-4">
                <div className="">
                  <textarea
            ...
            <div className="w-full md:w-1/3 sm:w-full px-4 mb-5 sm:mb-0">
                <span className="block mt-2 text-sm font-medium ">Social Links</span>
                <span className="text-xs ">Add your social media handles</span>
              </div>
              <div className="w-full md:w-2/3 sm:w-full px-4 md:grid md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                    <label htmlFor="instagram">Instagram</label>
                    <input id="instagram" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg" {...register('instagram')} />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="facebook">Facebook</label>
                    <input  id="facebook" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg" {...register('facebook')} />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="twitter">Twitter</label>
                    <input  id="twitter" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg" {...register('twitter')} />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="youtube">Youtube</label>
                    <input  id="youtube" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg" {...register('youtube')} />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="reddit">Reddit</label>
                    <input  id="reddit" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg"{...register('reddit')} />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="linkdin">Linkdin</label>
                    <input  id="linkdin" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg" {...register('linkedin')} />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="tiktok">TikTok</label>
                    <input  id="tiktok" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg"{...register('tiktok')} />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="snapchat">Snapchat</label>
                    <input id="snapchat" type="text" className="block py-4 px-3 w-full text-sm placeholder-gray-50 font-medium outline-none bg-white border border-gray-400 hover:border-gray-600 focus:border-green-500 rounded-lg"/>
                </div>
            </div>
