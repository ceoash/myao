...
function Newsletter() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl font-light md:mb-12 sm:text-xl text-gray-700">Stay up to date with news, announcements and exclusive deals feel free to sign up with your email.</p>
          <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div className="relative w-full">
                      ...
                      <input className="block p-3 pl-10 w-full text-sm rounded-l-lg  bordersm:rounded-none sm:rounded-l-lg bg-gray-200 border-gray-600 placeholder-gray-400 text-white focus:ring-orange-default focus:border-orange-default" placeholder="Enter your email" type="email" id="email" required />
                  </div>
                  <div>
