    ...
    <div className="lg:h-screen flex">
        <div className=" flex flex-col max-w-screen-xl px-4 md:grid md:grid-cols-2   mx-auto lg:gap-8 xl:gap-0 lg:py-16 items-center my-auto md:py-10">
            <div className="mb-6 md:mr-auto place-self-center order-2 md:order-1 lg:mb-0">
                <h1 className="max-w-2xl mb-12 text-2xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-5xl  text-primary-alt -rotate-12"><span className=' border-primary-alt border-4 px-4 py-2 border-dashed'>Make an Offer</span></h1>
                <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl  px-8 pt-6"><span>Negotiate & Save</span></h1>
            ...
            <div className="lg:mt-0 order-1 md:order-2 ">
                <div className='my-10'><img src='/images/MYAO_buy-process.png' alt='' /></div>
            </div>                
        </div>
    </div>
  )
